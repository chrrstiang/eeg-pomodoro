import { View, TouchableOpacity, Alert, useColorScheme } from "react-native";
      ...
      <View className="flex-1 justify-center items-center px-8">
        <View className="items-center w-full max-w-sm">
          ...
          <View className="items-center mb-8">
            <Text
              variant="h1"
              className=" dark:text-white text-center mb-4 text-foreground font-extrabold tracking-tight"
            >
              EEG Pomodoro
            </Text>
          ...
          <View className="w-full mb-6 space-y-4">
            ...
            <TouchableOpacity
              ...
              className="w-full bg-gray-100 dark:bg-gray-800 border-2 border-dashed border-gray-300 dark:border-gray-600 py-6 px-4 rounded-xl items-center mb-8"
            >
